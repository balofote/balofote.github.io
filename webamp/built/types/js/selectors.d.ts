...
export declare const getWindowOpen: import("reselect").OutputSelector<AppState, (windowId: WindowId) => boolean, (res: {
    [name: string]: import("./reducers/windows").WebampWindow;
...
export declare const getWindowPositions: import("reselect").OutputSelector<AppState, import("./reducers/windows").WindowPositions, (res: {
    [name: string]: import("./reducers/windows").WebampWindow;
}) => import("./reducers/windows").WindowPositions>;
...
export declare const getWindowsInfo: import("reselect").OutputSelector<AppState, import("./reducers/windows").WindowInfo[], (res1: {
    [key: string]: {
        height: number;
        width: number;
    };
}, res2: import("./reducers/windows").WindowPositions, res3: WindowId[]) => import("./reducers/windows").WindowInfo[]>;
export declare const getWindowGraph: import("reselect").OutputSelector<AppState, import("./resizeUtils").Graph, (res: import("./reducers/windows").WindowInfo[]) => import("./resizeUtils").Graph>;
...
export declare const getOpenWindows: import("reselect").OutputSelector<AppState, {
    [key: string]: import("./reducers/windows").WebampWindow;
}, (res: {
    [name: string]: import("./reducers/windows").WebampWindow;
}) => {
    [key: string]: import("./reducers/windows").WebampWindow;
}>;
export declare const getStackedLayoutPositions: import("reselect").OutputSelector<AppState, import("./reducers/windows").WindowPositions, (res1: {
    [key: string]: import("./reducers/windows").WebampWindow;
}, res2: boolean) => import("./reducers/windows").WindowPositions>;
